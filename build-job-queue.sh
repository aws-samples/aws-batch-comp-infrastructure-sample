...
if [ $# -lt 3 ] ; then
    echo "USAGE: "
    echo "build-job-queue.sh PROFILE REGION PROJECT_NAME INSTANCE_TYPE INSTANCE_AMI "
    echo "where: "
...
--parameters \
  ParameterKey=ProjectName,ParameterValue=$3 ParameterKey=AvailZoneId,ParameterValue=a ParameterKey=InstanceType,ParameterValue=$4 ParameterKey=AmiImageId,ParameterValue=$5
